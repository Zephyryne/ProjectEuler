...
def convert(value):
  output = ""
  #1000s
  for a in range(0,int(value/1000)):
    output += "M"
  #100s
  if int((value%1000)/100) == 9:
    output += "CM"
  elif int((value%1000)/100) >= 5:
    output += "D"
  elif int((value%500)/100) == 4:
    output += "CD"
  if int((value%500)/100) < 4:
    for b in range(0,int((value%500)/100)):
      output += "C"
  #10s
  if int((value%100)/10) == 9:
    output += "XC"
  elif int((value%100)/10) >= 5:
    output += "L"
  elif int((value%50)/10) == 4:
    output += "XL"
  if int((value%50)/10) < 4:
    for c in range(0,int((value%50)/10)):
      output += "X"
  #1s
  if int((value%10)) == 9:
    output += "IX"
